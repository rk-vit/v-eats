...
import { LogOut, Menu, Settings, Store, UtensilsCrossed } from "lucide-react"
...
export default function ShopLayout({ children }: ShopLayoutProps) {
  ...
  const navigation = [
    { name: "Dashboard", href: "/shop/dashboard", icon: Store },
    { name: "Menu", href: "/shop/menu", icon: UtensilsCrossed },
            ...
            <SheetContent side="left" className="pr-0">
              ...
              <div className="mt-8 px-7">
                <Avatar className="h-12 w-12">
                  <AvatarImage src="/placeholder.svg?height=40&width=40" alt="Shop" />
                  <AvatarFallback>GZ</AvatarFallback>
                </Avatar>
                <div className="mt-2">
                  <p className="font-medium">Gazebo</p>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuLabel>
                  <div className="flex flex-col space-y-1">
                    <p className="text-sm font-medium leading-none">Gazebo</p>
                    <p className="text-xs leading-none text-muted-foreground">Shop Owner</p>
                  </div>
                </DropdownMenuLabel>
                <DropdownMenuSeparator />
