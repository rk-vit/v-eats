...
export async function POST(req: NextRequest){
    ...
    const saltRounds = 10;
    const{shopName,email,shop_no,gstIn,password,role} = await req.json();
    try{
        ...
        try{
            console.log("trying");
            const resp = await db.query("INSERT INTO SHOP (shop_name,shop_no,gst_in,password,email) VALUES($1,$2,$3,$4,$5)",[shopName,gstIn,shop_no,hashed_pass,email]);
